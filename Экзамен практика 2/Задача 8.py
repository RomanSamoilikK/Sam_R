...
DepecheModeviolatorsongsdict = { 'World in My Eyes': 4.76, 'Sweetest Perfection': 5.43,
...
result = 0
for key in DepecheModeviolatorsongsdict:
    result = result + DepecheModeviolatorsongsdict[key]
print(result)
